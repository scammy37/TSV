 ...
 * trip: volume by status/priority/category, ticket age, throughput and the
...
router.get('/summary', asyncHandler(async (req, res) => {
  ...
  res.json({
    totals: {
      ...
      oldestOpenHours: t.oldest_open_hours === null
        ? null : Number(Number(t.oldest_open_hours).toFixed(1)),
    },
